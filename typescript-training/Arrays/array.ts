...
console.log(fruits.length);  // size of an array
...
let fruits1:string[]=["guava","pineapple","melon"];
let fruitsAndVegetables :string [] = fruits1.concat(vegetables);
...
//11. Iterate all the values of the array by using a for loop and for of loop. 
